...
export class GuidedTourService {
    ...
    public editAction(): void{
        if(this._currentTour.steps[this._currentTourStepIndex].editAction){
            this._currentTour.steps[this._currentTourStepIndex].editAction();
        }
        this.resetTour();
    }
    public backAction(): void{
        if(this._currentTour.steps[this._currentTourStepIndex].backAction){
            this._currentTour.steps[this._currentTourStepIndex].backAction();
        }
        this.resetTour();
    }

    public restartAction(): void{
        if(this._currentTour.steps[this._currentTourStepIndex].restartAction){
            this._currentTour.steps[this._currentTourStepIndex].restartAction();
        }
        this.resetTour();
    }
