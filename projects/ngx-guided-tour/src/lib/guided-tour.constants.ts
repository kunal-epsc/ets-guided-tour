export interface TourStep {
    ...
    //Custom
    /** Action that happens when the edit button is clicked */
    editAction ? : () => void;
    /** Controls edit button visibility **/
    showEdit ? : boolean;

    /** Action that happens when the restart button is clicked */
    restartAction ? : () => void;
    /** Displays restart button if set to false **/
    showRestart ? : boolean;

    /** Action that happens when back button is clicked **/
    backAction ? : () => void;
    /** Controls visibility of back button **/
    showBack ? : boolean;

    /** Controls visiblity of done button**/
    showDone ? : boolean;
